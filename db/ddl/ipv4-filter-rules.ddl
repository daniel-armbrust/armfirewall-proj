...
-- Stores IPv4 filter table rules for packets forwarded through the firewall host.
...
-- Stores IPv4 filter table rules for packets generated by the firewall host.
