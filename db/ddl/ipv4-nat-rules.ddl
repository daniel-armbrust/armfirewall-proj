...
-- Stores IPv4 NAT table PREROUTING rules applied before route lookup.
...
-- Stores IPv4 NAT table INPUT rules for packets delivered to local sockets.
...
-- Stores IPv4 NAT table OUTPUT rules for locally generated packets.
...
-- Stores IPv4 NAT table POSTROUTING rules applied after route lookup.
