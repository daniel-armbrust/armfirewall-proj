...
-- Stores IPv6 mangle table PREROUTING rules for early packet modification.
...
-- Stores IPv6 mangle table INPUT rules for packets delivered to local sockets.
...
-- Stores IPv6 mangle table FORWARD rules for routed packets.
...
-- Stores IPv6 mangle table OUTPUT rules for locally generated packets.
...
-- Stores IPv6 mangle table POSTROUTING rules for final packet modification.
