...
CHECK_INTERVAL_SECONDS = int(os.environ.get("HOMEFIREWALL_ARMFWORKREQD_INTERVAL", "5"))
BATCH_SIZE = int(os.environ.get("HOMEFIREWALL_ARMFWORKREQD_BATCH_SIZE", "10"))
ACTION_TIMEOUT_SECONDS = int(os.environ.get("HOMEFIREWALL_ARMFWORKREQD_ACTION_TIMEOUT", "300"))
