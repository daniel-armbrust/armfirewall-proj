...
ADAM_WAKE_WORD_WORKLET_URL = "/static/js/adam_wake_word_processor.js?v=20260722-command-16khz"
ADAM_WAKE_DETECTOR_WORKER_URL = "/static/js/adam_wake_detector_worker.js?v=20260722-confidence-gate"
ADAM_WAKE_ENROLLMENT_SAMPLES = 5
ADAM_WAKE_ENROLLMENT_DURATION_MS = 1_200
ADAM_WAKE_DETECTION_INTERVAL_MS = 250
ADAM_WAKE_DETECTION_STREAK = 3
ADAM_WAKE_DETECTION_THRESHOLD_MULTIPLIER = 1.6
ADAM_WAKE_PRE_ROLL_MS = 1_600
ADAM_COMMAND_MIN_CAPTURE_MS = 1_200
ADAM_COMMAND_SAMPLE_RATE = 16_000
ADAM_COMMAND_TRAILING_SILENCE_MS = 900
ADAM_COMMAND_SILENCE_THRESHOLD = 0.012
ADAM_COMMAND_TIMEOUT_MS = 8_000
