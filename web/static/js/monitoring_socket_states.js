(() => {
    ...
    let currentPeriod = localStorage.getItem("armfw.monitoring.socket_states.period") || "daily";
    let lastGraphs = [];
    ...
    periodButtons.forEach((button) => {
        button.addEventListener("click", () => {
            ...
            localStorage.setItem("armfw.monitoring.socket_states.period", currentPeriod);
            updateAllGraphs();
        });
    });
