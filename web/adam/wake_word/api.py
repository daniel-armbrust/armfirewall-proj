...
WAKE_WORD_TEMPLATE_FRAMES = 12
WAKE_WORD_FEATURES_PER_FRAME = 10
...
def _validated_profile(payload: AdamWakeWordProfilePayload) -> dict[str, Any]:
    ...
    if any(
        len(template) != WAKE_WORD_TEMPLATE_FRAMES
        or any(len(frame) != WAKE_WORD_FEATURES_PER_FRAME for frame in template)
